...
=======
EcoLogistics Web es un Sistema de Información (SI) diseñado para optimizar la recogida de residuos urbanos mediante el análisis en tiempo real del nivel de llenado de contenedores y la participación ciudadana en el reporte de incidencias.

## 2. Gestión del Capital Humano (Matriz de Asignación)
Para la ejecución de las 140 horas lectivas, he liderado un equipo de 20 profesionales bajo metodología **Extreme Programming (XP)**:
>>>>>>> 11b29d7b5be7bfacd2d7c43569f794cd220c4b7e
...
=======
* **Metodología Híbrida:** Combinación de **Scrum** (Sprints de 2 semanas) con el rigor de la **Ingeniería Clásica** (Modelado UML).
>>>>>>> 11b29d7b5be7bfacd2d7c43569f794cd220c4b7e
...
=======
El sistema implementa conceptos avanzados de programación:
* **Polimorfismo:** El método `reciclar()` se comporta de forma distinta según el tipo de objeto (Vidrio, Papel o Plástico).
* **Algoritmo de Rutas:** Lógica estructurada que prioriza contenedores con carga > 70%.

## 5. Documentación y Calidad (Fase 4)
Todos los artefactos de gestión y manuales se encuentran en la raíz del repositorio:
>>>>>>> 11b29d7b5be7bfacd2d7c43569f794cd220c4b7e
...
=======
*Este proyecto certifica la aplicación de los estándares de Ingeniería de Software requeridos para el curso.*
>>>>>>> 11b29d7b5be7bfacd2d7c43569f794cd220c4b7e
